        ...
        {user ? (
            ...
            <Form {...form}>
                ...
                {type === 'sign-up' && (
                    ...
                    <CustomInput
                    control={form.control} name='firstName' label= "Fist Name" placeholder='Enter your first name'/>
                    <CustomInput
                    ...
                    <CustomInput
                    control={form.control} name='postalCode' label= "Postal Code" placeholder='Example: 71000'/>
                    </div>
                    <div className="flex gap-4">
                    <CustomInput
